...
#[derive(Debug)]
pub struct EarthQuakeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl EarthQuakeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EarthQuake processing");
    
    let mut processor = EarthQuakeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EarthQuakeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EarthQuakeProcessor::new(false);
